...
- (void) addEventToCalendar:(GAEvent*)eventToSave{
    ...
    event.title = eventToSave.subject;
    
    // Set the start and end date
//    event.startDate =  [NSDate dateWithTimeIntervalSinceReferenceDate:*(eventToSave.startDate)] ;
//    event.endDate =  [NSDate dateWithTimeIntervalSinceReferenceDate:*(eventToSave.endDate)];
//
    event.startDate =  eventToSave.startDate ;
    event.endDate =  eventToSave.endDate;
    
    // Add details
    event.notes = eventToSave.subject;
